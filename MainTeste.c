...
void testeListaEncadeada()
{
    ...
    int vet[10];
    No *Cabecote = montarListaEncadeadaComCabecote();
    getDadosListaEncadeadaComCabecote(Cabecote, vet);
